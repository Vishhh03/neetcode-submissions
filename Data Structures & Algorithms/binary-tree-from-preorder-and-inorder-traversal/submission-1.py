...
class Solution:
    def buildTree(self, preorder: List[int], inorder: List[int]) -> Optional[TreeNode]:
        ...
        return root
        #Solution is thought of top down, where we pass the split left and right to make the nodes down till the base case where preorder is none (or inorder same len)
        #   bottoms up approach is difficult to picture in mind since we do not know the actual return needed